...
%  Pesquisar formas de integracao, descrever API de forma geral, mapeamento de dados (ontologias)
%
%  Apontar um modelo de dados para a integracao, referenciar as ontologias do
%  primeiro produto do fabri sobre ontologias.
%
%O link abaixo fala de diversar formas de troca de dados entre sistemas, e
%cobre tecnologias referenciadas no produto1 do fabri, triplas, rdf,
%ontologias, etc... A proposta feita aqui sera retirada deste topico: o que
%fazer? Resumo das tecnologias deste artigo; falar e denifir API.
...
%Falar de formato de dados para troca de dados
% https://en.wikipedia.org/wiki/Data_exchange

%Falar de interoperabilidade entre dominios
% https://en.wikipedia.org/wiki/Cross-domain_interoperability

%Falar de interoperabilidade semantica (envolve ontologias e afins)
...
%Os dados deverão ser obtidos de forma Nada de diff, uma vez puxado um
%conteudo ele eh mantido, fazer diff aumenta consideravelmente a implementacao
%para um ganho muito pequeno.
...
%\subsection{Outras formas de agregação}
%
%  Single Sign On, fazer referencia ao meu produto
%
%  Como mapear e trazer os usuarios, falar de SSO, propor federacao entre cidade
%  democratica e participa.
...
% Trabalhos futuros
%
%Uma ontologia similar ao OPA deve ser proposto em mais detalhes
%para o Cidade Democrática, a fim de direcionar o desenvolvimento de
